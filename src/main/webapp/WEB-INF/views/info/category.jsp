		...
		<div class="menu-bar">
			...
			<div class="menu-navi">
				<ul class="menu-bar-ul">
					...
					<a href="http://172.168.0.184:8080/info/food/${areaName}"><li class="${category eq '맛집' ? 'menu-clicked' : ''}">맛 &nbsp;&nbsp;&nbsp;집</li></a>
				</ul>
			</div>
		</div>
		...
		<div class="category-info-top">
			<div class="category-info-box">
				...
				<div class="category-category">
					<a href="http://172.168.0.184:8080/info/${areaName}"><span class="link-areaName">${areaName}</span></a> 
