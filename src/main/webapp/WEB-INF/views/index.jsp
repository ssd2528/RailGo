				...
				<div class="section-main clearfix">
					<div class="article-wrapper article-75">
						...
						<div class="article-item article-course">
							<a href="#">혹시 내일로 여행이 처음이신가요? 이런 코스는 어떠세요?</a> <span
								class="close-btn">x</span>
						</div>
						<!-- article-concept -->
						<div class="article-item article-concept">
							컨셉 추천 CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />
						...
						<div class="article-item article-sns-content">
							핫한 SNS 게시물 CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />
							CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />CONTENT<br />
						</div>
					</div>
					...
					<div class="article-wrapper article-25">
						...
						<div class="article-item article-sns-user">
							SNS 이용자 추천 <br> SNS 이용자 추천 <br>SNS 이용자 추천 <br>SNS
							이용자 추천 <br>SNS 이용자 추천 <br>SNS 이용자 추천 <br>
						</div>
						<!-- article-adsense -->
